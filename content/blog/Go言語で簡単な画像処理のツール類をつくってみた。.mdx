---
date: 2020-07-26T22:44:38.000+00:00
title: Go言語で簡単な画像処理のツール類をつくってみた。
thumbnail: https://i2.wp.com/www.mushroom-blog.com/wp-content/uploads/2020/08/golang.png?resize=360%2C238&ssl=1
tag:
  - サーバーサイド
---

Go 言語初学者です。普段の生息界隈は JS/TS+Java ですが、サーバーサイド言語の処理をもっと得意になりたいという理由から、今年から Go 言語に挑戦しています。挑戦理由は「モダン, マルチスレッド, コンテナ関連での活躍」が挙げられます。
...
![image.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/122992/6adeb0cc-1d7c-f1c7-00b4-62965a545332.png)
...
![image.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/122992/d97b9064-3d9e-d0c3-0513-eb11cebe175a.png)
...
![image.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/122992/23ac7924-78b3-9bbc-5205-62c5a6f2cb50.png)
...
↓ イメージ
![image.png](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/122992/66cb82fb-7a7a-94fb-7ac5-701df1aa966f.png)
